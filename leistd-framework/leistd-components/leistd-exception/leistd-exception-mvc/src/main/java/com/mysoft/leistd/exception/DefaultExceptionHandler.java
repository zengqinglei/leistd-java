...
public class DefaultExceptionHandler implements ExceptionHandler {
    ...
    public ResponseEntity<Object> handle(Throwable e, HttpServletRequest request) throws Throwable {
        ...
        // 重新组织异常
        BusinessException bizException = switch (e) {
            case BusinessException businessException -> businessException;
            case BindException bindException -> new UnprocessableEntityException(
                    getErrorsFromBindException(bindException),
                    "输入的信息有误");
            case ConstraintViolationException constraintViolationException -> new UnprocessableEntityException(
                    getErrorsFromConstraintViolationException(constraintViolationException),
                    "输入的信息有误");
            case CommonException commonException -> new BadRequestException(
            ...
            default -> new InternalServerErrorException(e, "系统异常，请联系管理员");
        };
        ...
        if (bizException instanceof UnprocessableEntityException unprocessableEntityException) {
