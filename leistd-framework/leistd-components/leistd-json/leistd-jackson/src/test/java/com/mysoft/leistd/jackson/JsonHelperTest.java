...
public class JsonHelperTest {
    ...
    public void testDeserializeCustomers() {
        ...
        List<CustomerDTO> customers = JsonHelper.parseObject(jsonString, new TypeReference<List<CustomerDTO>>() {
        });
        Assert.assertEquals(customers.get(0).getId(), "3192c38b-c923-417a-bf1d-213b551784c9");
        Assert.assertEquals(customers.get(0).getName(), "测试客户1");
    }
    ...
    public void testDeserializeCustomerPage() {
        ...
        PageDTO<CustomerDTO> customerPage = JsonHelper.parseObject(jsonString, new TypeReference<PageDTO<CustomerDTO>>() {
        });
